...
const bookFlight = (flightNumber) => {
    ...
    return availableFlights.includes((item) => item.flightNumber === flightNumber) ? `Flight No. ${flightNumber} booked` : 'Error has occured';
}
...
const searchAndBookFlightIIFE = (function(from, to) {
    return bookFlight(searchFlight(from, to));
})('Delhi', 'Mumbai');

// console.log(searchAndBookFlightIIFE);
