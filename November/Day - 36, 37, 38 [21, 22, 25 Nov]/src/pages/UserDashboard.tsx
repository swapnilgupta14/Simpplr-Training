...
const UserDashboard = () => {
    ...
    return (
        <>
            <header className="flex w-full justify-between px-8 items-center py-4 pb-0 my-2">
                <div>
            ...
            <div className='flex flex-row-reverse items-start justify-between gap-3 p-3'>
                                        ...
                                        <div className="flex flex-wrap gap-2 text-sm">
                                            {priorities.map(priority => (
                                                <button
                                                    ...
                                                    className={`px-4 py-2 rounded-full transition-colors ${priority.color} ${newTask.priority === priority.value ? 'bg-black text-white' : 'text-black'
                                                        }`}
                                                >
                                                    {priority.label}
                                                </button>
